...
module.exports = class Migration1718032940394 {
    name = 'Migration1718032940394'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "order_products" ("orderId" uuid NOT NULL, "productId" uuid NOT NULL, "quantity" integer, CONSTRAINT "PK_ffd362cc3722cddd5bd60d153aa" PRIMARY KEY ("orderId", "productId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" integer NOT NULL, "productId" uuid NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "quantity"`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD "quantity" integer`);
